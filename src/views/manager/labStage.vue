<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
        <el-input v-model="searchId" :prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="请输入编号查询" :disabled="data.loading"></el-input>
        <el-input v-model="searchLabName" :prefix-icon="Search" style="width: 220px; margin-right: 10px" placeholder="请输入实验室查询" :disabled="data.loading"></el-input>
  ...
  try {
    const res = await request.get('/lab_phase_report/selectByCondition', {
      params: {
        ...
        labName: searchLabName.value || undefined,
