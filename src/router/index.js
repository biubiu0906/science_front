  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'institutionSettings', meta: { name: '基础设置' }, component: () => import('@/views/manager/InstitutionInfoPlaceholder.vue') },
        { path: 'institutionOrganization', meta: { name: '组织建设' }, component: () => import('@/views/manager/InstitutionInfoPlaceholder.vue') },
        { path: 'institutionDigital', meta: { name: '信息化建设' }, component: () => import('@/views/manager/InstitutionInfoPlaceholder.vue') },
        { path: 'institutionResearchDepartment', meta: { name: '科研管理部门' }, component: () => import('@/views/manager/InstitutionInfoPlaceholder.vue') },
        { path: 'verticalTopic', meta: { name: '纵向课题' }, component: () => import('@/views/manager/InstitutionInfoPlaceholder.vue') },
        { path: 'horizontalTopic', meta: { name: '横向课题' }, component: () => import('@/views/manager/InstitutionInfoPlaceholder.vue') },
