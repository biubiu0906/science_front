  ...
  routes: [
    { path: '/', redirect: '/manager/dashboard' },
    {
      ...
      children: [
        ...
        // 新增实验室申请
        { path: 'labApply', meta: { name: '任务书' }, component: () => import('@/views/manager/LabApply.vue'), },
        { path: 'labMember', meta: { name: '组织成员管理' }, component: () => import('@/views/manager/LabMember.vue'), },
        { path: 'labSelect', meta: { name: '任务书' }, component: () => import('@/views/manager/LabSelect.vue'), },
        ...
        { path: 'laboratory', meta: { name: '组织信息' }, component: () => import('@/views/manager/Laboratory.vue'), },
        ...
        { path: 'labStage', meta: { name: '阶段报告' }, component: () => import('@/views/manager/labStage.vue'), },
        { path: 'labStageApply', meta: { name: '阶段报告' }, component: () => import('@/views/manager/labStageApply.vue'), },
        { path: 'school', meta: { name: '学校信息' }, component: () => import('@/views/manager/School.vue'), },
        { path: 'schoolAdmin', meta: { name: '学校管理员信息' }, component: () => import('@/views/manager/SchoolAdmin.vue'), },
      ]
    },
    {
      path: '/front',
